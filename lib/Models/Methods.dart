      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 30.h,),
            InkWell(child: text(context, 'الرئيسية', 21, white,), onTap: (){goToPage(context, MainScreen());},),
            SizedBox(height: 5.h,),
            InkWell(child: text(context, 'من نحن', 21, white,), onTap: (){goToPage(context, AboutUsMain());},),
            SizedBox(height: 5.h,),
            InkWell(child: text(context, 'خدماتنا', 21, white,), onTap: (){goToPage(context, Services());},),
            SizedBox(height: 5.h,),
            InkWell(child: text(context, 'اعمالنا', 21, white,), onTap: (){goToPage(context, OurWork());},),
            SizedBox(height: 5.h,),
            InkWell(child: text(context, 'المدونة', 21, white,), onTap: (){goToPage(context, blogs());},),
            SizedBox(height: 5.h,),
            InkWell(child: text(context, 'الباقات', 21, white,), onTap: (){goToPage(context, PackagesMain());},),
            SizedBox(height: 5.h,),
            InkWell(child: text(context, 'شركاءنا', 21, white,), onTap: (){goToPage(context, OurPartnerMain());},),
            SizedBox(height: 5.h,),
            InkWell(child: text(context, 'تواصل معنا', 21, white,), onTap: (){goToPage(context, ContactWithUsMain());},),
            SizedBox(height: 5.h,),
